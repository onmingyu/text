<template>
  <div class="container">
    ...
    <div class="weui_cells_title">健康卡:</div>
      <div class="weui_cells weui_cells_access" style="margin-top:10px;">
        <a @click="selectCard" class="weui_cell" href="javascript:;" v-if="card.cardId !== -1">
          <div class="weui_cell_hd">
            <i class="fa fa-credit-card fa-2x icon-color" style="width:45px;margin-right:5px;display:block;"></i>
          </div>
          <div class="weui_cell_bd weui_cell_primary">
    ...
    <div v-show="isInp == '0'">
      <div class="weui_cells_title">
        <p class="am-ft-sm am-ft-gray">
          <span class="am-ft-orange"><i class="fa fa-info-circle"></i></span> 只支持查询开单日期起15日内检验单
        </p>
      </div>
    ...
    <div v-show="isInp == '1'">
      <div class="weui_cells_title">
        <p class="am-ft-sm am-ft-gray">
          <span class="am-ft-orange"><i class="fa fa-info-circle"></i></span> 住院病人显示当前住院期内所有检验单
        </p>
      </div>
    </div>
    ...
    <div class="weui_cells weui_cells_access ft-sm" style="margin-top:10px;">
        <a v-for="check in checks" @click="viewCheck($index)" class="weui_cell" href="javascript:;">
          <div class="weui_cell_hd">
            <i class="fa fa-heartbeat fa-2x icon-color" style="width:35px;margin-right:5px;display:block;"></i>
          </div>
          <div class="weui_cell_bd weui_cell_primary">
            <p>报告类型：<span class="am-ft-sm am-ft-blue">{{check.checkType}}</span></p>
            <p>开单日期：<span class="am-ft-sm am-ft-blue">{{check.date}}</span></p>
            <p>检验编号：<span class="am-ft-sm am-ft-blue">{{check.id}}</span></p>
            <p>检验名称：<span class="am-ft-sm am-ft-blue">{{check.name}}</span></p>
          ...
          <div class="weui_cell_bd">
            <p>
              <span v-show="check.status != '1'" class="am-ft-gray am-ft-13">未出报告</span>
            </p>
          </div>
          <div v-show="check.status == '1'" class="weui_cell_ft">
          </div>
        </a>
    </div>
