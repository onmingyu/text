      ...
      <div class="weui_cells weui_cells_access">
        <a @click="goOrderDetail(order.id)" class="weui_cell" href="javascript:;">
          ...
          <div class="weui_cell_bd weui_cell_primary">
            ...
            <p>日期：<span class="am-ft-sm am-ft-blue">{{order.regDate}}</span></p>
            <p>科室：<span class="am-ft-sm am-ft-blue">{{order.deptName}}</span></p>
            <p>医生：<span class="am-ft-sm am-ft-blue">{{order.doctorName}}</span></p>
...
export default {
  ...
  methods: {
    getOrders: function () {
      ...
      this.$ajax.get('GetOrderList', 'RegOrder', { type: this.tabName }).then(function (data) {
    ...
    goOrderDetail: function (orderId) {
      this.$router.go({ name: 'regOrderDetail', params: { orderId: orderId } })
    }
  },
  ready: function () {
    this.getOrders()
