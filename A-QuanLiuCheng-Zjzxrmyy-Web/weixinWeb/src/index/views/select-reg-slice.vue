          ...
          <a @click="sliceClicked($index)" v-for="ts in timeSlices" class="weui_cell" href="javascript:;">
            ...
            <div class="weui_cell_bd">
              <p>
                ...
                <span v-show="ts.totalCount <= 0" class="am-ft-gray am-ft-13">已约满</span>
              </p>
            </div>
...
export default {
  ...
  ready: function () {
    ...
    this.$ajax.get('GetTimeSlices', 'Depart', { deptId: this.departId, doctorId: this.drId, doctordepartNm: this.deptName, branch: this.branch }).then(function (data) {
