    ...
    <div id="scroll-wrapper" class="scroll-wrapper">
      <div class="scroller">
        <div align="center">
          ...
          <br /> <p style="color:red">请选择要就诊的科室和医生，祝君安康！</p>
        </div>
        <div class="weui_cells weui_cells_access" style="margin-top:10px;">
          <a @click="sliceClicked($index)" v-for="ts in timeSlices" class="weui_cell" href="javascript:;">
            ...
            <div class="weui_cell_bd weui_cell_primary">
              <p>{{ts.drName}} <span class="am-ft-13 am-ft-gray">{{ts.drDepartName}}  ({{ts.drTitle}})  {{ts.TXDeptName}}</span></p>
            ...
            <div class="weui_cell_bd">
              <p>
                ...
                <span class="blue_tag">{{ts.totalFee}} 元</span>
                <span v-show="ts.leaveCount == 0" class="am-ft-gray am-ft-13">已约满</span>
              </p>
            </div>
...
export default {
  ...
  methods: {
    ...
    sliceClicked: function (idx) {
      ...
      this.setRegSlice(timeSlice.departId, timeSlice.departName, timeSlice.drDepartName, timeSlice.drId, timeSlice.drName, timeSlice.drTitle, this.selectedDay,
  ...
  ready: function () {
    ...
    this.$ajax.get('GetTodayTimeSlices', 'Depart', { deptId: this.departId, doctorId: this.drId, doctordepartNm: this.deptName, branch: this.branch }).then(function (data) {
